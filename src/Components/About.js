...
export default function About() {
    return (
        ...
        margin: "0%"}}>
            <h1 style={{backgroundColor: "#22031F", padding: "0%",
            margin: "0%"}}>About Whodunnit</h1>
            ...
            <h5>Questions are heavily slanted towards golden-age mysteries (your Marples, your Poirots) because they're my favorites. 
            </h5>
